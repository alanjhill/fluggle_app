...
import 'package:fluggle_app/screens/sign_in/email_password/email_password_sign_in_model.dart';
  ...
  static Widget create(BuildContext context, {VoidCallback? onSignedIn}) {
    ...
    return ChangeNotifierProvider<EmailPasswordSignInModel>(
      ...
      child: Consumer<EmailPasswordSignInModel>(
        builder: (_, EmailPasswordSignInModel model, __) => EmailPasswordSignInPage._(
          model: model,
