...
const Color kFluggleCubeColor = Color.fromRGBO(9, 89, 157, 1);
...
const Color kFluggleLetterColor = Colors.white;
const Color kFluggleLetterHighlightColor = Color.fromRGBO(69, 209, 253, 1);
const Color kFluggleSwipeLineColor = kFluggleLetterHighlightColor;
...
const kEggTimerTextStyle = TextStyle(
  ...
  letterSpacing: 1.5,
  color: Color.fromRGBO(0, 89, 157, 1),
);
