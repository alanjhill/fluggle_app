...
import 'package:fluggle_app/sign_in/email_password/email_password_sign_in_model.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:provider/provider.dart';

class EmailPasswordSignInPage extends StatefulWidget {
  const EmailPasswordSignInPage._({Key? key, required this.model, this.onSignedIn}) : super(key: key);
  ...
  static Widget create(BuildContext context, {VoidCallback? onSignedIn}) {
    ...
    return ChangeNotifierProvider<EmailPasswordSignInModel>(
      ...
      child: Consumer<EmailPasswordSignInModel>(
        builder: (_, EmailPasswordSignInModel model, __) => EmailPasswordSignInPage._(model: model, onSignedIn: onSignedIn),
      ),
    );
  }
